        ...
        return (
            <div className="rl_container">
                <form onSubmit={this.submitForm}>
                    <h2>Add <img src="/images/reg.png" alt="Login" className="login_image" /> User</h2>
                    ...
                    <button type="submit"><i className="fa fa-edit"></i>&nbsp;&nbsp;Register</button>
                    <div className="error">
                        {this.state.error}
                    </div>
                </form>
                <div className="currnet_user">
                    <h4>Current users:</h4>
                    <table>
                        <thead>
                            <tr>
